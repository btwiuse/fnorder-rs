...
const ADJECTIVES: [&str; 168] = ["23rd",
                                 ...
                                 "upgraded",
                                 "Mayan"];
// const INTROS: [&str; 34] = ["4 out of 5 dentists recommend that",
...
const NOUNS: [&str; 192] = ["911 file",
                            ...
                            "laptop",
                            "nanite"];
const PLACES: [&str; 94] = ["(not available at your clearance)",
                            "Afghanistan",
                            "Alpha Centauri",
                            "Alpha Complex",
                            "Atlantis",
                            ...
                            "Smallville",
                            "the Shire"];
const PREPOSITIONS: [&str; 102] = ["assumes responsibility for",
                                   "avoids servants of",
                                   "deals with",
                                   "elopes with",
                                   "evades agents of",
...
const PRONOUNS: [&str; 6] = ["his", "my", "our", "the", "your", "their"];
...
fn preposition() -> &'static str {
    PREPOSITIONS.choose(&mut rand::rng()).unwrap()
}
fn pronoun() -> &'static str {
